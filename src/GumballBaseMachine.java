...
public class GumballBaseMachine {
	...
	public GumballBaseMachine(int cost_per_gumball, int coin_inserted){
	...
	public void decision(int cost_per_gumball,int total) {
		GumballBaseMachine demo = new GumballBaseMachine(cost_per_gumball, total);
